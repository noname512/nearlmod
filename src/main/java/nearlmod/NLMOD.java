...
public class NLMOD implements EditCardsSubscriber, EditCharactersSubscriber, EditKeywordsSubscriber, EditRelicsSubscriber, EditStringsSubscriber, PostBattleSubscriber, PostInitializeSubscriber, PostDungeonInitializeSubscriber, AddCustomModeModsSubscriber, OnStartBattleSubscriber, OnPlayerLoseBlockSubscriber, RelicGetSubscriber {
    ...
    private void initializeEvents() {
        ...
        BaseMod.addEvent(MephistoBattle.ID, MephistoBattle.class, "Special");
    ...
    private void initializeSpecialImg() {
        ...
        specialImg.put(Gummy.ORB_ID, new TextureAtlas.AtlasRegion(new Texture("resources/nearlmod/images/512/card_friend_gummy.png"), 0, 0, 512, 512));
    }
...
//        modList.add(new CustomMod())
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new CheeseFondue()); // 奶酪火锅
        BaseMod.addCard(new WhatSheSaw()); // 她所见
        BaseMod.addCard(new FindYourWayThroughTheSnow()); // 家乡的“温暖”
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new OldRules(), NEARL_GOLD);
        BaseMod.addRelicToCustomPool(new TangibleTerror(), NEARL_GOLD);
