...
public class Platinum extends AbstractMonster {
    ...
    public static final String IMAGE = "resources/nearlmod/images/monsters/platinum.png";
    ...
    public Platinum(float x, float y) {
        ...
        if (AbstractDungeon.ascensionLevel >= 7)
            setHp(110);
        loadAnimation("resources/nearlmod/images/monsters/char_204_platnm/char_204_platnm.atlas", "resources/nearlmod/images/monsters/char_204_platnm/char_204_platnm37.json", 1.5F);
