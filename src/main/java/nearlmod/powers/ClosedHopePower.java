...
public class ClosedHopePower extends AbstractPower {
    ...
    public ClosedHopePower(AbstractCreature owner, int amount) {
        ...
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/nearlmod/images/powers/closedhope power 84.png"), 0, 0, 84, 84);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/nearlmod/images/powers/closedhope power 32.png"), 0, 0, 32, 32);
    }
