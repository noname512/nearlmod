...
public class DefensiveFormationPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public DefensiveFormationPower(AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/nearlmod/images/powers/defensiveformation power 128.png"), 0, 0, 128, 128);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/nearlmod/images/powers/defensiveformation power 48.png"), 0, 0, 48, 48);
        type = PowerType.BUFF;
        this.owner = owner;
        updateDescription();
    }
