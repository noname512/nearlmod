...
public class FlamingEdgePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public FlamingEdgePower(AbstractCreature owner, int amount) {
        ...
        ID = POWER_ID;
        this.owner = owner;
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("rhinemod/images/powers/flamingedge power 84.png"), 0, 0, 84, 84);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("rhinemod/images/powers/flamingedge power 32.png"), 0, 0, 32, 32);
        type = PowerType.BUFF;
        this.amount = amount;
        updateDescription();
    }
