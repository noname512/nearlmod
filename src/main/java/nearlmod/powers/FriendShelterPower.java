...
public class FriendShelterPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public FriendShelterPower(AbstractCreature owner) {
        ...
        ID = POWER_ID;
        this.owner = owner;
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/nearlmod/images/powers/friendshelter power 84.png"), 0, 0, 84, 84); // TODO
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/nearlmod/images/powers/friendshelter power 32.png"), 0, 0, 32, 32);
        type = PowerType.BUFF;
        priority = 120;
        updateDescription();
    }
