...
public class WFPPower extends AbstractPower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    public WFPPower(AbstractCreature owner) {
        ...
        ID = POWER_ID;
        this.owner = owner;
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("images/powers/wfp power 128.png"), 0, 0, 128, 128);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("images/powers/wfp power 48.png"), 0, 0, 48, 48);
        type = PowerType.BUFF;
        updateDescription();
    }
