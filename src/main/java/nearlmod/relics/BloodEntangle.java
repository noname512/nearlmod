...
public class BloodEntangle extends CustomRelic {
    ...
    public static final Texture IMG = new Texture("resources/nearlmod/images/relics/bloodentangle.png");
    public static final Texture IMG_OUTLINE = new Texture("resources/nearlmod/images/relics/bloodentangle_p.png");
