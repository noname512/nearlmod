...
public class ImaginaryFear extends CustomRelic {
    ...
    public static final Texture IMG = new Texture("resources/nearlmod/images/relics/imaginaryfear.png");
    public static final Texture IMG_OUTLINE = new Texture("resources/nearlmod/images/relics/imaginaryfear_p.png");
