...
public class UpgradedCoreCaster extends CustomRelic {
    ...
    public static final Texture IMG = new Texture("resources/nearlmod/images/relics/upgradedcorecaster.png");
    public static final Texture IMG_OUTLINE = new Texture("resources/nearlmod/images/relics/upgradedcorecaster_p.png");
